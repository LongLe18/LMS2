...
const { api, oauth } = require('../config');
            ...
            mailOptions = {
                ...
                <div style="max-width: 900px">
                    ...
                    <div>
                        ...
                        <p><span style="color: black">Thông tin đăng nhập trên hệ thống ôn thi Đánh giá năng lực ĐHQGHN của Trung tâm Đào tạo và Chuyển giao công nghệ HSA  https://hsaplus.edu.vn// đã được khôi phục</p>
                        <div style="border: 2px solid rgb(137,166,191); border-radius: 20px; padding: 10px; background-color: rgb(219,238,244)">
                            ...
                            <ul>
                                <li><p><span style="color: black">Tên đăng nhập: ${
                                    content.gmail
                                }</span></p></li>
                                <li><p><span style="color: black">Mật khẩu: ${
                                    content.password
                                }</span></p></li>
                            </ul>
                        </div>
                        <p><span style="color: black">Bạn hãy đăng nhập ${
                            process.env.URL + content.auth_url
                        } bằng tài khoản nêu trên.</p>
                        <p><span style="color: black">Trân trọng!</p>
                    </div>
                    <hr/>
                    <p><span style="color: black"><span style="font-weight:bold">CHƯƠNG TRÌNH ĐƯỢC XÂY DỰNG VÀ PHÁT TRIỂN BỞI</span><br/>
            ...
            mailOptions = {
                ...
                <div style="max-width: 900px">
                    ...
                    <div>
                        ...
                        <p><span style="color: black">Tài khoản Luyện thi của bạn trên hệ thống trên hệ thống ôn thi Đánh giá năng lực ĐHQGHN của Trung tâm Đào tạo và Chuyển giao công nghệ HSA https://hsaplus.edu.vn// đã được kích hoạt.</p>
                        <div style="border: 2px solid rgb(137,166,191); border-radius: 20px; padding: 10px; background-color: rgb(219,238,244)">
                            <p><span style="color: black; font-weight:bold">Thông tin khóa học</span></p>
                            <ul>
                                <li><p><span style="color: black">Tên khóa học: ${
                                    content.ten_khoa_hoc
                                }</span></p></li>
                                <li><p><span style="color: black">Mã đơn hàng: #${
                                    content.ma_hoa_don
                                }</span></p></li>
                                <li><p><span style="color: black">Ngày: ${d.getDay()}/${d.getMonth()}/${d.getFullYear()}</span></p></li>
                                <li><p><span style="color: black">Tổng cộng: (VND) ${content.tong_tien
                                    .toFixed(2)
                                    .replace(
                                        /\d(?=(\d{3})+\.)/g,
                                        '$&,'
                        ...
                        <p><span style="color: black">Bạn hãy đăng nhập ${
                            api.login_url
                        } bằng tài khoản để bắt đầu học tập theo lộ trình.</p>
                        <p><span style="color: black">Trân trọng!</p>
                    </div>
                    <hr/>
                        <p><span style="color: black"><span style="font-weight:bold">CHƯƠNG TRÌNH ĐƯỢC XÂY DỰNG VÀ PHÁT TRIỂN BỞI</span><br/>
