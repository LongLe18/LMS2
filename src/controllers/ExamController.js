...
const getAll_admin = async (req, res) => {
    ...
    const totalRecords = await sequelize.query(
        ...
        (
            ...
            loai_de_thi.loai_de_thi_id=de_thi.loai_de_thi_id WHERE de_thi.loai_de_thi_id=1 AND ${filter} AND de_thi.de_mau_id IS NULL
        ) 
        UNION (
            SELECT de_thi.de_thi_id, de_thi.anh_dai_dien, de_thi.ten_de_thi, de_thi.trang_thai, de_thi.ngay_tao, loai_de_thi.mo_ta, loai_de_thi.loai_de_thi_id,
            ...
            LEFT JOIN loai_de_thi ON loai_de_thi.loai_de_thi_id=de_thi.loai_de_thi_id WHERE de_thi.loai_de_thi_id=2 AND ${filter} AND de_thi.de_mau_id IS NULL
        ) 
        UNION (
            SELECT de_thi.de_thi_id, de_thi.anh_dai_dien, de_thi.ten_de_thi, de_thi.trang_thai, de_thi.ngay_tao, loai_de_thi.mo_ta, loai_de_thi.loai_de_thi_id, 
            ...
            WHERE de_thi.loai_de_thi_id=3 AND ${filter} AND de_thi.de_mau_id IS NULL
        ) 
        UNION (
            SELECT de_thi.de_thi_id, de_thi.anh_dai_dien, de_thi.ten_de_thi, de_thi.trang_thai, de_thi.ngay_tao, loai_de_thi.mo_ta, loai_de_thi.loai_de_thi_id, 
            ...
            WHERE de_thi.loai_de_thi_id=4 AND ${filter} AND de_thi.de_mau_id IS NULL)
