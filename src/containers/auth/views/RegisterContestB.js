...
const RegisterContestB = (props) => {
    ...
    const onSubmit = (values) => {
        values.dia_chi = values.university_unit + ' -  Hà Nội'
        values.truong_hoc = values.university_unit + ' -  Hà Nội'
        const callback = () => {
    ...
    const renderCard = () => {
        return (
            ...
            >
              <Option value={0} >Căn cước công dân</Option>
    ...
    const renderNumberLearning = () => {
        return (
            <Select
              onChange={(numberLearning) => setState({ ...state, numberLearning: numberLearning })}
              placeholder="Chọn số năm học tiếng anh"
            >
    ...
    const renderLevel = () => {
        return (
            <Select
              onChange={(level) => setState({ ...state, level: level })}
              placeholder="Chọn cấp độ giáo dục"
            >
              <Option value={1} >Secondary (up to 16 years)</Option>
              <Option value={2} >Secondary (up to 16-19 years)</Option>
              <Option value={3} >Degree (or equivalent)</Option>
              <Option value={4} >Post-graduate</Option>
            </Select>
        );  
    }
     
    const renderLevelJob = () => {
        return (
            <Select
              onChange={(level) => setState({ ...state, levelJob: level })}
              placeholder="Chọn trình độ nghề nghiệp"
            >
              <Option value={1} >Self-employed</Option>
              <Option value={2} >Employer/Partner</Option>
              <Option value={3} >Employee (Senior level)</Option>
              <Option value={4} >Employee (Middle/Junior level)</Option>
              <Option value={5} >Homeworker</Option>
    ...
    const renderReason = () => {
        return (
            <Select
              onChange={(reason) => setState({ ...state, reason: reason })}
              placeholder="Chọn lý do thi"
            >
              <Option value={'Higher education extended course (3 months or more)'} >Higher education extended course (3 months or more)</Option>
              <Option value={'Higher education short course (3 months or less)'} >Higher education short course (3 months or less)</Option>
              <Option value={'Other educational purposes'} >Other educational purposes</Option>
              <Option value={'Registration as a doctor'} >Registration as a doctor</Option>
              <Option value={'Immigration'} >Immigration</Option>
              <Option value={'Employment'} >Employment</Option>
              <Option value={'Professional registration (not medical)'} >Professional registration (not medical)</Option>
              <Option value={'Personal reasons'} >Personal reasons</Option>
              <Option value={'Registration as a nurse (including CGFNS)'} >Registration as a nurse (including CGFNS)</Option>
              <Option value={'Registration as a dentist'} >Registration as a dentist</Option>
        ...
        <>
            ...
            <div className="login-form"  style={{marginBottom: 100}}>
                ...
                <Form  onFinish={onSubmit} form={form} layout='vertical'>
                    ...
                    <Form.Item initialValue={state.department}
                        name="department" 
                        rules={[
                            { required: true, message: 'Loại công tác là trường bắt buộc.' },
                        ]}
                    >
                        <Radio.Group onChange={onChangeDepartment}>
                            <Radio value={1}> Học viện/trường ĐH, CĐ </Radio>
                            <Radio value={2}> Cơ quan, đơn vị khác </Radio>
                        </Radio.Group>
                    </Form.Item>

                    <Form.Item style={{display: state.department === 2 ? 'none' : 'block'}}
                        name="university_unit"
                        label="Học viện/trường đang học tập công tác (Bao gồm khoa/viện)"
                        rules={[
                            { required: true, message: 'Trường học là bắt buộc' }
                        ]}
                    >
                        <Input size="normal" placeholder='Ví dụ: Khoa Công nghệ Thông tin - Học Viện Bưu Chính Viễn Thông' />
                    </Form.Item>

                    <Form.Item style={{display: state.department === 1 ? 'none' : 'block'}}
                        name="university_unit" 
                        label="Cơ quan, đơn vị đang học tập công tác (Bao gồm khoa/viện)"
                        rules={[
                            { required: true, message: 'Cơ quan/Đơn vị là bắt buộc' }
                        ]}
                    >
                        <Input size="normal" placeholder='Nhập cơ quan, đơn vị' />
                    </Form.Item>
                    ...
                    <Row>
                        <Col xl={9} sm={9} xs={9}>
                            <Form.Item
                                name="years_studying_english"
                                label="Thông tin khác"
                                rules={[
                                    { required: true, message: 'Thông tin khác là bắt buộc' }
                                ]}
                            >
                                {renderNumberLearning()}
                            </Form.Item>
                        </Col>
                        <Col xl={9} sm={9} xs={9} offset={3}>
                            <Form.Item
                                ...
                                label="Cấp độ"
                                rules={[
                                    { required: true, message: 'Cấp độ là bắt buộc' }
                                ]}
                            >
                                {renderLevel()}
                            </Form.Item>
                    ...
                    <Row>
                        <Col xl={9} sm={9} xs={9}>
                            <Form.Item
                                ...
                                rules={[
                                    { required: true, message: 'Ngành nghề là bắt buộc' }
                                ]}
                            >
                                <Input placeholder='Nhập nghề nghiệp (Tiếng anh)'/>
                            </Form.Item>
                        </Col>
                        <Col xl={9} sm={9} xs={9} offset={3}>
                            <Form.Item
                                ...
                                rules={[
                                    { required: true, message: 'Trình độ nghề nghiệp là bắt buộc' }
                                ]}
                            >
                                {renderLevelJob()}
                            </Form.Item>
                    ...
                    <Form.Item
                        name="reason_for_taking_test"
                        rules={[
                            { required: true, message: 'Lý do thi là bắt buộc' }
                        ]}
                    >
                        {renderReason()}
                    </Form.Item>
...
export default RegisterContestB;