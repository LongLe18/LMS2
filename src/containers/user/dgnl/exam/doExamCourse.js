...
import { Layout, Row, Col, Modal, Button, notification, Input, Alert, Upload, message, List, Comment, Space } from 'antd';
...
const ExamCourseDetail = () => {
    ...
    if (exam.status === 'success') {
        breadcrumbs.push({ title: 'Đề thi', link: `/luyen-tap/kiem-tra/${params.idCourse}` }, { title: exam.data.ten_de_thi, link: `/luyen-tap/xem/${params.idExam}/${params.idCourse}` });
    }
...
export default ExamCourseDetail;